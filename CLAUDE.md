...
etp movies ingest plan --radarr [--source DIR] [--force] [--json] [-o FILE] [--refine FILE] [pattern]
etp movies ingest apply MANIFEST.kdl [--dry-run] [--json]
etp television ingest plan --sonarr [--source DIR] [--force] [--json] [-o FILE] [--refine FILE] [pattern]
